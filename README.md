...
# How to use
Instructions on how to set up and use this program can be found in the [Documentation](https://discord-otp-forcer.codeberg.page/en/user/setup/) or the Wiki tab in the repository.<br>

...
> [!NOTE]  
> Going forward I won't maintain this program often. I don't have the time or inclination to maintain this for more than my personal needs anymore. If the community wishes they can write their own bug fixes and features and add pull requests, and I'll merge them in here. But I won't be attending any more bug fix or help requests unless you file a pull request and fix the issue yourself. Thanks to the contributors and people who help each other out in this. You've been real ones
